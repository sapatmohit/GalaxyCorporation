      ...
      <div className="mx-auto w-full px-4 sm:px-6 py-8 sm:py-12">
        <div className="relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            {/* Left: Image Carousel */}
            <div className="relative w-full h-[280px] sm:h-[340px] md:h-[400px] lg:h-[420px] rounded-2xl overflow-hidden shadow-lg">
              <img
                key={current}
                src={IMAGES[current]}
            ...
            >
              <motion.h2 
                className="text-2xl sm:text-[28px] md:text-[32px] lg:text-[36px] font-heading font-normal text-[#0a2540]"
              ...
              >
                <motion.a
                  ...
                  className="inline-flex items-center justify-center h-10 sm:h-11 px-6 sm:px-7 rounded-md bg-[#0ea5ff] text-white text-sm sm:text-[15px] font-semibold shadow-sm hover:bg-[#0596ea] transition-colors"
